...
- Output: `(1, 3)` — raw logits, urutan kelas `[fake2d, fake3d, real]`.
  Terapkan **softmax manual** di kode (model tidak include softmax layer).
...
6. softmax(output) masing-masing, ambil index [2] (kelas "real")
